...
PW = "testpass123"
USERS = [(9,"alice@test.com"),(10,"bob@test.com"),(11,"charlie@test.com"),(12,"dave@test.com"),(13,"eve@test.com")]
CHATS = [
    ...
    async with httpx.AsyncClient(timeout=30) as c:
        ...
        r = await c.post(f"{BASE}/rooms", json={
            ...
            "settings": {"max_rounds": 3, "phase_durations": {
                ...
                "interaction": 8, "discussion": 8, "result": 5,
            }},
        }, headers=h)
        ...
        for rnd in range(1, 4):
            ...
            async with SessionLocal() as db:
                ...
                for uid, _ in USERS:
                    ...
                    for _ in range(3):
                        ...
                        msg = await chat_repo.create_message(db, room_id=room.id, user_id=uid, content=content)
            ...
            async with SessionLocal() as db:
                coordinator = await game_repo.get_player_by_role(db, game_id=game_id, role="coordinator")
                ...
                for uid, _ in USERS:
                    ...
                    await vote_repo.create_vote(db, game_id=game_id, round_number=rnd,
