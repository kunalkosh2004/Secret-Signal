...
export function LobbyPage() {
  ...
  const handleCreateRoom = async () => {
    ...
    setLoading(true)
    try {
      const room = await createRoom({ max_players: 8, settings: {} })
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full p-6 bg-gray-100 border border-gray-400/30 rounded text-left hover:border-accent/40 transition-colors group disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-mono tracking-wider text-gray-800 group-hover:text-accent transition-colors">
              ...
              <div className="w-10 h-10 rounded-full border border-accent/30 bg-accent/5 flex items-center justify-center glow-red">
